...
// Generates all missing source files; never overwrites.
// ============================================================
import fs from 'fs';
...
export class PollinationsClient {
  ...
  async generateVideo(prompt) {
    // Pollinations video generation is not yet stable; throw a clear error.
  ...
  async generateMusic(prompt) {
    // Pollinations music generation is not yet stable; throw a clear error.
