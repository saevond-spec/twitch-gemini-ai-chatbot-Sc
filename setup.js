...
`,
  ...
  // ---- EVENTSUB CLIENT (NEW: robust state machine, optional failure handling) ----
...
`,
  ...
  // ---- APP.JS (fixed: cooldown, media URL, unhandled rejection protection, conversation store updates, EventSub optional) ----
  'src/app.js': `
