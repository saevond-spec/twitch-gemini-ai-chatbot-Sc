...
function buildTwitchAuthUrl(req) {
    ...
    // CORRECTED: Added moderator:read:followers – required for channel.follow EventSub subscriptions
    const scopes = [
        'chat:read',
        'chat:edit',
        'user:bot',
        'user:read:chat',
        'user:write:chat',
        'moderator:read:followers' // <-- Required for channel follow subscriptions
    ];
